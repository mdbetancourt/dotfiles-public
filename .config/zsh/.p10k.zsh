# Generated by Powerlevel10k configuration wizard on 2024-08-04 at 17:29 -04.
...
# The list of segments shown on the left. Fill it with the most important segments.
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$BLACK_COLOR
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=$WHITE_COLOR
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$SUCCESS_COLOR
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$ERROR_COLOR
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='󰞷'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$PRIMARY_COLOR
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$WHITE_COLOR
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=$WHITE_COLOR
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=$SUCCESS_COLOR

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='✔'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=$WHITE_COLOR
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=$SUCCESS_COLOR

  # Status when it's just an error code (e.g., '1'). No need to show it if prompt_char is enabled as
  # it will signify error by turning red.
  typeset -g POWERLEVEL9K_STATUS_ERROR=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=$WHITE_COLOR
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=$ERROR_COLOR
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=$WHITE_COLOR
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=$ERROR_COLOR

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=$WHITE_COLOR
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=$ERROR_COLOR
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=238
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='󱐋'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE=%n@${${${Z4H_SSH##*:}//\%/%%}:-%m}
